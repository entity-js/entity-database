...
loader.register('Entity/Database', function () {
  'use strict';
...
loader.register('Entity/Database/*', function (ns) {
  'use strict';

  var filename = path.join(
    __dirname, 'lib', ns.substring('Entity/Database/'.length)
  );
...
module.exports = function (core) {
  ...
  var Database = loader('Entity/Database');
  Object.defineProperty(core, 'database', {
    value: new Database(core)
  });
};
